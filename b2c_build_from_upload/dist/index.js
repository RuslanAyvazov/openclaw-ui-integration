...
import { B2cBuildError, executeBuild, } from "./build.js";
const pluginConfigSchema = Type.Object({
    skillRoot: Type.Optional(Type.String({
    ...
    maxLogBytes: Type.Optional(Type.Integer({
...
const buildParameters = Type.Object({
    ...
    storage: Type.Optional(Type.Union([Type.Literal("iceberg"), Type.Literal("parquet")], {
...
export default defineToolPlugin({
    ...
    tools: (tool) => [
        tool({
            ...
            description: "Builds a B2C SQL project from workspace/uploads/<uploadId>. "
